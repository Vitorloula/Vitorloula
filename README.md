...
Sou um entusiasta da tecnologia com foco em desenvolvimento de software, especialmente em aplicações **mobile** e **web**. Atualmente, estou me aprofundando em **React**, **Jetpack Compose**, **cloud computing** com **AWS** e **bancos de dados NoSQL com Firebase**.  
